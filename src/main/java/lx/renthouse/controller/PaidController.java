...
import lx.renthouse.service.PaidService;
import lx.renthouse.service.TopaidService;
import lx.renthouse.service.UserlistService;
import java.text.SimpleDateFormat;
import java.util.Date;;

@Controller
@RequestMapping("/text2/paid")
public class PaidController {
	...
	//添加租金信息到topaid表
		...
		public String gotopay(Integer topaidId,Model model){
			Date dt=new Date();
			System.out.println("topaidId=========>"+topaidId);
			...
			paid.setStatus("租金已缴");
			topaidService.gotopay(topaidId, paid);
